...
const _c1 = [1, "row"];
const _c2 = [1, "col"];
const _c3 = ["formControlName", "codigo", "matInput", "", "type", "text"];
const _c4 = ["formControlName", "descripcion", "matInput", "", "type", "text"];
const _c5 = ["formControlName", "unidad", "matInput", "", "type", "text"];
const _c6 = ["formControlName", "cantidad", "matInput", "", "type", "number"];
class ItemComponent {
