...
const _c0 = ["cols", "3", "rowHeight", "200px"];
const _c1 = [3, "colspan", "rowspan"];
const _c2 = [1, "full-width", "full-height"];
class AiuComponent {
    constructor() { }
    ngOnInit() {
    }
}
AiuComponent.ngComponentDef = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AiuComponent, selectors: [["app-aiu"]], factory: function AiuComponent_Factory(t) { return new (t || AiuComponent)(); }, consts: 15, vars: 4, template: function AiuComponent_Template(rf, ctx) { if (rf & 1) {
...
const _c1 = ["mat-raised-button", "", "color", "primary", "type", "button", 3, "click"];
const _c2 = ["mat-table", "", "formArrayName", "costs", 1, "mat-elevation-z8", 3, "dataSource"];
const _c3 = ["matColumnDef", "gasto"];
const _c4 = ["mat-header-cell", "", 4, "matHeaderCellDef"];
const _c5 = ["mat-cell", "", 3, "formGroupName", 4, "matCellDef"];
const _c6 = ["mat-footer-cell", "", 4, "matFooterCellDef"];
const _c7 = ["matColumnDef", "porcentaje"];
const _c8 = ["matColumnDef", "add"];
const _c9 = ["matColumnDef", "delete"];
const _c10 = ["mat-header-row", "", 4, "matHeaderRowDef"];
const _c11 = ["mat-row", "", 4, "matRowDef", "matRowDefColumns"];
const _c12 = ["mat-footer-row", "", 4, "matFooterRowDef", "matFooterRowDefSticky"];
const _c13 = ["mat-header-cell", ""];
function TableAiuComponent_th_6_Template(rf, ctx) { if (rf & 1) {
...
const _c14 = ["mat-cell", "", 3, "formGroupName"];
const _c15 = [1, "full-width"];
const _c16 = ["matInput", "", "formControlName", "description", "placeholder", "Descripci\u00F3n"];
function TableAiuComponent_td_7_Template(rf, ctx) { if (rf & 1) {
...
function TableAiuComponent_th_10_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "th", _c13);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](1, " Porcentaje ");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
} }
const _c18 = ["matInput", "", "formControlName", "percent", "placeholder", "Porcentaje", "type", "number"];
const _c19 = ["matSuffix", ""];
function TableAiuComponent_td_11_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "td", _c14);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](1, "mat-form-field", _c15);
    ...
    const index_r181 = ctx.index;
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("formGroupName", index_r181);
} }
function TableAiuComponent_td_12_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "td", _c17);
...
function TableAiuComponent_th_14_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "th", _c13);
} }
const _c20 = ["mat-icon-button", "", "aria-label", "Example icon-button with a heart icon", 3, "disabled", "click"];
function TableAiuComponent_td_15_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function TableAiuComponent_td_15_Template_button_click_1_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r185); const row_r182 = ctx.$implicit; const index_r183 = ctx.index; const ctx_r184 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r184.createCost(row_r182.value, index_r183); });
...
function TableAiuComponent_td_16_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "td", _c17);
} }
function TableAiuComponent_th_18_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "th", _c13);
} }
const _c21 = ["mat-icon-button", "", "aria-label", "Example icon-button with a heart icon", 3, "click"];
function TableAiuComponent_td_19_Template(rf, ctx) { if (rf & 1) {
    ...
    const index_r187 = ctx.index;
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("formGroupName", index_r187);
} }
function TableAiuComponent_td_20_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "td", _c17);
} }
const _c22 = ["mat-header-row", ""];
function TableAiuComponent_tr_21_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "tr", _c22);
} }
const _c23 = ["mat-row", ""];
function TableAiuComponent_tr_22_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "tr", _c23);
} }
const _c24 = ["mat-footer-row", ""];
function TableAiuComponent_tr_23_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "tr", _c24);
} }
class TableAiuComponent {
    constructor(formBuilder, proyectoService, costoIndirectoService) {
    ...
    ngOnInit() {
        ...
        this.proyectoService.project$
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((proyecto) => {
    ...
    createCost(value, index) {
        ...
        if (index >= this.costs.length) {
            ...
            this.costoIndirectoService.postCostoIndirecto(cost).subscribe((response) => {
            ...
            this.costoIndirectoService.putCostoIndirecto(cost).subscribe((response) => {
                console.log(response);
