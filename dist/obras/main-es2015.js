...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'aiu',
                loadChildren: () => __webpack_require__.e(/*! import() | aiu-aiu-module */ "aiu-aiu-module").then(__webpack_require__.bind(null, /*! ./aiu/aiu.module */ "./src/app/aiu/aiu.module.ts")).then(m => m.AiuModule)
            },
            {
                path: 'analysis',
                loadChildren: () => __webpack_require__.e(/*! import() | analysis-analysis-module */ "analysis-analysis-module").then(__webpack_require__.bind(null, /*! ./analysis/analysis.module */ "./src/app/analysis/analysis.module.ts")).then(m => m.AnalysisModule)
            },
            {
                path: 'budget',
                loadChildren: () => __webpack_require__.e(/*! import() | budget-budget-module */ "budget-budget-module").then(__webpack_require__.bind(null, /*! ./budget/budget.module */ "./src/app/budget/budget.module.ts")).then(m => m.BudgetModule)
            },
            {
                path: 'information',
                loadChildren: () => __webpack_require__.e(/*! import() | information-information-module */ "information-information-module").then(__webpack_require__.bind(null, /*! ./information/information.module */ "./src/app/information/information.module.ts")).then(m => m.InformationModule)
            },
            {
                path: 'item',
                loadChildren: () => __webpack_require__.e(/*! import() | item-item-module */ "item-item-module").then(__webpack_require__.bind(null, /*! ./item/item.module */ "./src/app/item/item.module.ts")).then(m => m.ItemModule)
            },
            {
                path: 'chapter',
                loadChildren: () => Promise.all(/*! import() | chapter-chapter-module */[__webpack_require__.e("common"), __webpack_require__.e("chapter-chapter-module")]).then(__webpack_require__.bind(null, /*! ./chapter/chapter.module */ "./src/app/chapter/chapter.module.ts")).then(m => m.ChapterModule)
            },
        ]
    }
];
...
class DetalleService {
    ...
    getDetallesByAnalisisId(id) {
        return this.http.get(`${this.urlApi}?analisisId=${id}`);
    }
    getDetallesByItemId(id) {
...
class ItemService {
    ...
    setCurrentCostoDirecto(costo) {
        this.currentCost = costo;
        this.cost$.next(this.currentCost);
    }
    getItemByProyectoId(proyectoId) {
        return this.http.get(`${this.urlApi}?proyectoId=${proyectoId}`);
    }
    getItemById(id) {
        return this.http.get(`${this.urlApi}/${id}`);
...
const _c0 = ["class", "container", 4, "ngIf"];
...
const _c0 = ["novalidate", "", 3, "formGroup", "ngSubmit"];
const _c1 = [1, "shipping-card"];
const _c2 = [1, "row"];
const _c3 = [1, "col"];
const _c4 = [1, "full-width"];
const _c5 = ["matInput", "", "placeholder", "Nombre del Proyecto", "formControlName", "projectName"];
const _c6 = ["matInput", "", "placeholder", "Contratante", "formControlName", "contractor"];
const _c7 = [4, "ngIf"];
const _c8 = ["matInput", "", "placeholder", "Proponente", "formControlName", "proponent"];
const _c9 = ["matInput", "", "placeholder", "Fecha de Presentaci\u00F3n", "formControlName", "endDate", 3, "matDatepicker"];
const _c10 = ["matSuffix", "", 3, "for"];
const _c11 = ["pickerEnd", ""];
const _c12 = ["matInput", "", "placeholder", "Fecha de Modificaci\u00F3n", "formControlName", "editDate", 3, "disabled", "matDatepicker"];
const _c13 = ["pickerEdit", ""];
const _c14 = ["matInput", "", "placeholder", "Herramienta Menor", "formControlName", "tool", "type", "number"];
const _c15 = ["matInput", "", "placeholder", "Prestaciones Sociales", "formControlName", "benefits", "type", "number"];
const _c16 = ["matInput", "", "placeholder", "Desperdicio Materiales", "formControlName", "waste", "type", "number"];
const _c17 = ["matInput", "", "placeholder", "Herramienta Menor", "formControlName", "comments"];
const _c18 = ["mat-raised-button", "", "color", "primary", "type", "submit", 3, "disabled"];
function InfoFormComponent_mat_error_14_Template(rf, ctx) { if (rf & 1) {
...
function InfoFormComponent_mat_error_18_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
...
function InfoFormComponent_mat_error_36_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " First name is ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "strong");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](3, "required");
...
function InfoFormComponent_mat_error_40_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Last name is ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "strong");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](3, "required");
...
function InfoFormComponent_mat_error_44_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Last name is ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "strong");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](3, "required");
...
class InfoFormComponent {
    constructor(fb, proyectoService) {
        this.fb = fb;
        this.proyectoService = proyectoService;
    }
    ngOnInit() {
    ...
    onSubmit() {
        ...
        this.proyectoService.postProyecto(proyecto).subscribe((response) => {
...
InfoFormComponent.ngComponentDef = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: InfoFormComponent, selectors: [["app-info-form"]], factory: function InfoFormComponent_Factory(t) { return new (t || InfoFormComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_services_proyecto_proyecto_service__WEBPACK_IMPORTED_MODULE_2__["ProyectoService"])); }, inputs: { proyecto: "proyecto" }, consts: 52, vars: 12, template: function InfoFormComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        const _r78 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](25);
        const _r79 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](31);
...
const _c0 = ["matInput", "", "placeholder", "Buscar", 3, "keyup"];
const _c1 = ["mat-table", "", 1, "mat-elevation-z8", 3, "dataSource"];
const _c2 = ["matColumnDef", "codigo", 1, "mat-column"];
const _c3 = ["mat-header-cell", "", 4, "matHeaderCellDef"];
const _c4 = ["mat-cell", "", 3, "click", 4, "matCellDef"];
const _c5 = ["matColumnDef", "descripcion", 1, "mat-column"];
const _c6 = ["matColumnDef", "valorUnitario", 1, "mat-column"];
const _c7 = ["mat-cell", "", 4, "matCellDef"];
const _c8 = ["matColumnDef", "valorParcial", 1, "mat-column"];
const _c9 = ["mat-header-row", "", 4, "matHeaderRowDef"];
const _c10 = ["mat-row", "", 4, "matRowDef", "matRowDefColumns"];
const _c11 = [3, "length", "pageSize", "page"];
const _c12 = ["mat-header-cell", ""];
function ItemTableComponent_th_9_Template(rf, ctx) { if (rf & 1) {
...
const _c13 = ["mat-cell", "", 3, "click"];
function ItemTableComponent_td_10_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ItemTableComponent_td_10_Template_td_click_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r114); const item_r112 = ctx.$implicit; const ctx_r113 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r113.selectItem(item_r112); });
...
function ItemTableComponent_th_15_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "th", _c12);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](1, " Valor Unitario ");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
} }
const _c14 = ["mat-cell", ""];
function ItemTableComponent_td_16_Template(rf, ctx) { if (rf & 1) {
...
function ItemTableComponent_th_18_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "th", _c12);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](1, " Valor Parcial ");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
} }
function ItemTableComponent_td_19_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "td", _c14);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpipe"](2, "currency");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
...
const _c15 = ["mat-header-row", ""];
function ItemTableComponent_tr_20_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "tr", _c15);
} }
const _c16 = ["mat-row", ""];
function ItemTableComponent_tr_21_Template(rf, ctx) { if (rf & 1) {
...
class ItemTableComponent {
    ...
    ngAfterViewInit() {
        this.proyectoService.project$
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["switchMap"])((proyecto) => {
            this.proyecto = proyecto;
...
ItemTableComponent.ngComponentDef = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: ItemTableComponent, selectors: [["app-item-table"]], factory: function ItemTableComponent_Factory(t) { return new (t || ItemTableComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](src_app_core_services_item_item_service__WEBPACK_IMPORTED_MODULE_3__["ItemService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_core_services_proyecto_proyecto_service__WEBPACK_IMPORTED_MODULE_4__["ProyectoService"])); }, viewQuery: function ItemTableComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, outputs: { itemSelected: "itemSelected" }, consts: 23, vars: 5, template: function ItemTableComponent_Template(rf, ctx) { if (rf & 1) {
...
const _c0 = [1, "sidenav-container"];
const _c1 = ["fixedInViewport", "", "mode", "dialog", 1, "sidenav"];
const _c2 = ["drawer", ""];
const _c3 = ["mat-list-item", "", "routerLink", "/home"];
const _c4 = ["mat-list-item", "", "routerLink", "/information"];
const _c5 = ["mat-list-item", "", "routerLink", "/aiu"];
const _c6 = ["mat-list-item", "", "routerLink", "/analysis"];
const _c7 = ["mat-list-item", "", "routerLink", "/budget"];
const _c8 = ["mat-list-item", "", "routerLink", "/chapter"];
const _c9 = ["color", "primary"];
const _c10 = ["type", "button", "aria-label", "Toggle sidenav", "mat-icon-button", "", 3, "click"];
const _c11 = ["aria-label", "Side nav toggle icon"];
const _c12 = ["mat-icon-button", "", 3, "matMenuTriggerFor"];
const _c13 = ["menu", "matMenu"];
const _c14 = ["mat-menu-item", "", 3, "click"];
const _c15 = ["mat-menu-item", "", 3, "click", 4, "ngFor", "ngForOf"];
function NavComponent_button_33_Template(rf, ctx) { if (rf & 1) {
    const _r55 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", _c14);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NavComponent_button_33_Template_button_click_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r55); const proyecto_r53 = ctx.$implicit; const ctx_r54 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r54.setCurrentProject(proyecto_r53); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const proyecto_r53 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵselect"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", proyecto_r53.nombre_Obra, " ");
} }
class NavComponent {
    constructor(dialog, proyectoService) {
        this.dialog = dialog;
        this.proyectoService = proyectoService;
    }
    openDialogCreate() {
        const dialogRef = this.dialog.open(_dialog_create_dialog_create_component__WEBPACK_IMPORTED_MODULE_1__["DialogCreateComponent"], {
            width: '600px'
        });
    }
    ngOnInit() {
...
NavComponent.ngComponentDef = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: NavComponent, selectors: [["app-nav"]], factory: function NavComponent_Factory(t) { return new (t || NavComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialog"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_services_proyecto_proyecto_service__WEBPACK_IMPORTED_MODULE_3__["ProyectoService"])); }, consts: 34, vars: 2, template: function NavComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NavComponent_Template_button_click_20_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r56); const _r50 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](2); return _r50.toggle(); });
...
const _c4 = ["mat-cell", "", 3, "click", 4, "matCellDef"];
const _c5 = ["matColumnDef", "descripcion", 1, "mat-column"];
const _c6 = ["matColumnDef", "unidad", 1, "mat-column"];
const _c7 = ["mat-cell", "", 4, "matCellDef"];
const _c8 = ["matColumnDef", "precio", 1, "mat-column"];
const _c9 = ["mat-header-row", "", 4, "matHeaderRowDef"];
const _c10 = ["mat-row", "", 4, "matRowDef", "matRowDefColumns"];
const _c11 = [3, "length", "pageSize", "page"];
const _c12 = ["mat-header-cell", ""];
function TableAnalysisComponent_th_9_Template(rf, ctx) { if (rf & 1) {
...
const _c13 = ["mat-cell", "", 3, "click"];
function TableAnalysisComponent_td_10_Template(rf, ctx) { if (rf & 1) {
...
function TableAnalysisComponent_th_12_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", _c12);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Descripci\u00F3n ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function TableAnalysisComponent_td_13_Template(rf, ctx) { if (rf & 1) {
...
function TableAnalysisComponent_th_15_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", _c12);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Unidad ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
const _c14 = ["mat-cell", ""];
function TableAnalysisComponent_td_16_Template(rf, ctx) { if (rf & 1) {
...
function TableAnalysisComponent_th_18_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", _c12);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Precio ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function TableAnalysisComponent_td_19_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", _c14);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
...
const _c15 = ["mat-header-row", ""];
function TableAnalysisComponent_tr_20_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "tr", _c15);
} }
const _c16 = ["mat-row", ""];
function TableAnalysisComponent_tr_21_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "tr", _c16);
} }
class TableAnalysisComponent {
    constructor(analisisUnitarioService) {
    ...
    fetchAnalisisUnitario(filter, page) {
        console.log(filter);
...
TableAnalysisComponent.ngComponentDef = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TableAnalysisComponent, selectors: [["app-table-analysis"]], factory: function TableAnalysisComponent_Factory(t) { return new (t || TableAnalysisComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_core_services_analisis_unitario_analisis_unitario_service__WEBPACK_IMPORTED_MODULE_2__["AnalisisUnitarioService"])); }, viewQuery: function TableAnalysisComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { proyecto: "proyecto" }, outputs: { analisisSelected: "analisisSelected" }, consts: 23, vars: 5, template: function TableAnalysisComponent_Template(rf, ctx) { if (rf & 1) {
...
const _c0 = ["mat-table", "", 1, "mat-elevation-z8", 3, "dataSource"];
const _c1 = ["matColumnDef", "descripcion"];
const _c2 = ["mat-header-cell", "", 4, "matHeaderCellDef"];
const _c3 = ["mat-cell", "", 4, "matCellDef"];
const _c4 = ["mat-footer-cell", "", 4, "matFooterCellDef"];
const _c5 = ["matColumnDef", "costo"];
const _c6 = ["mat-header-row", "", 4, "matHeaderRowDef"];
const _c7 = ["mat-row", "", 4, "matRowDef", "matRowDefColumns"];
const _c8 = ["mat-footer-row", "", 4, "matFooterRowDef", "matFooterRowDefSticky"];
const _c9 = ["mat-header-cell", ""];
function TableCostComponent_th_8_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "th", _c9);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](1, " Descripci\u00F3n ");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
} }
const _c10 = ["mat-cell", ""];
function TableCostComponent_td_9_Template(rf, ctx) { if (rf & 1) {
...
const _c11 = ["mat-footer-cell", ""];
function TableCostComponent_td_10_Template(rf, ctx) { if (rf & 1) {
...
function TableCostComponent_th_12_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "th", _c9);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](1, " Costo ");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
} }
function TableCostComponent_td_13_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "td", _c10);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpipe"](2, "currency");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
} if (rf & 2) {
    const gasto_r10 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵselect"](1);
...
function TableCostComponent_td_14_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "td", _c11);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpipe"](2, "currency");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
...
const _c12 = ["mat-header-row", ""];
function TableCostComponent_tr_15_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "tr", _c12);
} }
const _c13 = ["mat-row", ""];
function TableCostComponent_tr_16_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "tr", _c13);
} }
const _c14 = ["mat-footer-row", ""];
function TableCostComponent_tr_17_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "tr", _c14);
} }
class TableCostComponent {
    constructor(itemService, costoIndirectoService, proyectoService) {
        this.itemService = itemService;
    ...
    ngOnInit() {
        this.proyectoService.project$
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["switchMap"])((costo) => {
...
const _c11 = [3, "length", "pageSize", "page"];
const _c12 = ["mat-header-cell", ""];
function TableResourceComponent_th_9_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", _c12);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " C\u00F3digo ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
const _c13 = ["mat-cell", "", 3, "click"];
function TableResourceComponent_td_10_Template(rf, ctx) { if (rf & 1) {
...
function TableResourceComponent_th_12_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", _c12);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Descripci\u00F3n ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function TableResourceComponent_td_13_Template(rf, ctx) { if (rf & 1) {
    const _r72 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", _c13);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TableResourceComponent_td_13_Template_td_click_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r72); const item_r70 = ctx.$implicit; const ctx_r71 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r71.selectResource(item_r70); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
function TableResourceComponent_th_15_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", _c12);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Unidad ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
const _c14 = ["mat-cell", ""];
function TableResourceComponent_td_16_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", _c14);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
function TableResourceComponent_th_18_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", _c12);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Precio ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function TableResourceComponent_td_19_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", _c14);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipe"](2, "currency");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
const _c15 = ["mat-header-row", ""];
function TableResourceComponent_tr_20_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "tr", _c15);
} }
const _c16 = ["mat-row", ""];
function TableResourceComponent_tr_21_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "tr", _c16);
} }
class TableResourceComponent {
    constructor(recursoBasicoService) {
    ...
    fetchRecursoBasico(filter, page) {
        console.log(filter);
...
const _c1 = ["mat-table", "", "formArrayName", "detalle", 1, "mat-elevation-z8", 3, "dataSource"];
const _c2 = ["matColumnDef", "codigo"];
const _c3 = ["mat-header-cell", "", 4, "matHeaderCellDef"];
const _c4 = ["mat-cell", "", 4, "matCellDef"];
const _c5 = ["mat-footer-cell", "", 4, "matFooterCellDef"];
const _c6 = ["matColumnDef", "descripcion"];
const _c7 = ["matColumnDef", "rendimiento"];
const _c8 = ["mat-cell", "", "class", "rendimiento", 3, "formGroupName", 4, "matCellDef"];
const _c9 = ["matColumnDef", "unidad"];
const _c10 = ["matColumnDef", "precio"];
const _c11 = ["matColumnDef", "subTotal"];
const _c12 = ["matColumnDef", "delete"];
const _c13 = ["mat-cell", "", 3, "formGroupName", 4, "matCellDef"];
const _c14 = ["mat-header-row", "", 4, "matHeaderRowDef"];
const _c15 = ["mat-row", "", 4, "matRowDef", "matRowDefColumns"];
const _c16 = ["mat-footer-row", "", 4, "matFooterRowDef", "matFooterRowDefSticky"];
const _c17 = ["mat-raised-button", "", "color", "primary", "type", "button", 3, "disabled", "click"];
const _c18 = ["mat-header-cell", ""];
...
const _c21 = ["mat-cell", "", 1, "rendimiento", 3, "formGroupName"];
const _c22 = ["matInput", "", "formControlName", "rendimiento", "placeholder", "Rendimiento", "type", "number", 3, "keyup"];
function TableComponent_td_12_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keyup", function TableComponent_td_12_Template_input_keyup_2_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r41); const index_r39 = ctx.index; const ctx_r40 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r40.applyChanges($event.target.value, index_r39); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
function TableComponent_td_24_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", _c19);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipe"](2, "currency");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
const _c23 = ["mat-cell", "", 3, "formGroupName"];
const _c24 = ["mat-icon-button", "", "aria-label", "Example icon-button with a heart icon", 3, "click"];
...
class TableComponent {
    ...
    ngOnInit() {
        ...
        if (this.itemId !== 0) {
            this.detalleService.getDetallesByItemId(this.itemId).subscribe((detalles) => {
                detalles.forEach((d) => {
        ...
        if (this.analisisId !== 0) {
            this.detalleService.getDetallesByAnalisisId(this.analisisId).subscribe((detalles) => {
                detalles.forEach((d) => {
                    d.subTotal = d.precio * d.rendimiento;
                    this.addRow(d, false);
                });
    ...
    deleteDetalle(index) {
        this.detalleService.deleteDetalle(index).subscribe((response) => {
            console.log(response);
        }, (error) => {
            console.error(error.error);
        });
